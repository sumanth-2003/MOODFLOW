        ...
        <div className="min-h-screen bg-gradient-to-b from-pink-50 via-blue-50 to-teal-50 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="block p-4 bg-white rounded-lg shadow-lg hover:shadow-2xl transform hover:scale-105 transition-transform duration-300 flex flex-col items-center">
                        ...
                        <div className="flex flex-col flex-grow justify-end w-full text-center mt-auto">
                            ...
                            <Link href="/journaling">
                                <button className="mt-4 px-4 py-2 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-500 transition-colors">
                                    Start Journaling
                                </button>
                            </Link>
                        </div>
                    ...
                    <div className="block p-4 bg-white rounded-lg shadow-lg hover:shadow-2xl transform hover:scale-105 transition-transform duration-300 flex flex-col items-center">
                        ...
                        <div className="flex flex-col flex-grow justify-end w-full text-center mt-auto">
                            ...
                            <Link href="/meditation">
                                <button className="mt-4 px-4 py-2 bg-teal-600 text-white font-semibold rounded-lg hover:bg-teal-500 transition-colors">
                    ...
                    <div className="block p-4 bg-white rounded-lg shadow-lg hover:shadow-2xl transform hover:scale-105 transition-transform duration-300 flex flex-col items-center">
                        ...
                        <div className="flex flex-col flex-grow justify-end w-full text-center mt-auto">
                            ...
                            <Link href="/therapy">
                                <button className="mt-4 px-4 py-2 bg-pink-600 text-white font-semibold rounded-lg hover:bg-pink-500 transition-colors">
            ...
            <div className="container mx-auto mt-16 flex flex-col lg:flex-row items-center bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="lg:w-1/2 w-full p-6 lg:pl-8 lg:py-8">
                    <h2 className="text-5xl font-extrabold bg-gradient-to-r from-purple-700 to-teal-400 bg-clip-text text-transparent text-center lg:text-left mb-4 drop-shadow-lg">
                        Why Choose MoodFlow?
                    </h2>
