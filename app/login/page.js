                    ...
                    <div className="flex items-center w-full max-w-md px-6 py-16 mx-auto lg:w-2/4">
                        <div className="flex-1">
                            <div className="text-center">
                                <h2 className="text-4xl font-bold text-center text-zinc-700 dark:text-white">kMITRA</h2>
                                <p className="mt-3 text-zinc-500 dark:text-zinc-300">Sign in to access your account</p>
                            </div>
                            <div className="mt-8">
                                <form onSubmit={handleSubmit}>
                                    <div>
                                        <label htmlFor="username" className="block mb-2 text-sm text-zinc-600 dark:text-zinc-200">Username</label>
                                        <input type="text" name="username" id="username" value={username} onChange={(e) => setUsername(e.target.value)} onFocus={handleInputChange} placeholder="Your Username" className="block w-full px-4 py-2 mt-2 text-zinc-700 placeholder-zinc-400 bg-white border border-zinc-200 rounded-md dark:placeholder-zinc-600 dark:bg-zinc-900 dark:text-zinc-300 dark:border-zinc-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                    </div>
                                    <div className="mt-6">
                                        <div className="flex justify-between mb-2">
                                            <label htmlFor="password" className="text-sm text-zinc-600 dark:text-zinc-200">Password</label>
